...
public class Test3Activity extends ComponentActivity {
    ...
    private long syncInterval = 15;
    private final int[] SAMPLING_RATES = {13, 26, 52, 104, 208};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        syncLogger = new CsvLogger(this, "test3_sync_time.csv");
        ...
        findViewById(R.id.start_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                samplingRateIndex = 0;
                samplingRate = SAMPLING_RATES[samplingRateIndex];
    ...
    private void startRecording() {
        if (isRecording) {
            ...
            Toast.makeText(Test3Activity.this, "Already Recording", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        Log.d(TAG, "Start Recording, Sampling Rate: " + samplingRate);
        String fileName = "test3_" + samplingRate + ".csv";
        csvLogger = new CsvLogger(Test3Activity.this, fileName);
        ...
        syncDuringRecording();
        Toast.makeText(Test3Activity.this, "Started Recording", Toast.LENGTH_SHORT).show();
    }
    ...
    private void stopRecording() {
        if (!isRecording) {
            ...
            Toast.makeText(Test3Activity.this, "Not Recording", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (samplingRateIndex < SAMPLING_RATES.length - 1) {
            samplingRateIndex++;
            samplingRate = SAMPLING_RATES[samplingRateIndex];
            startRecording(recordingDuration);
        } else {
            Toast.makeText(Test3Activity.this, "Recording Completed", Toast.LENGTH_SHORT).show();
        }
    }
