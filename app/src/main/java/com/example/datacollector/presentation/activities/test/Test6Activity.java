...
public class Test6Activity extends ComponentActivity {
    ...
    private int samplingRate = 208;// 13, 26, 52, 104, 208, 416, 833, 1666
    private final long[] RECORDING_DURATIONS_MIN = {30};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        syncLogger = new CsvLogger(this, "test6_sync_time.csv");
    ...
    private void startRecording() {
        if (isRecording) {
            ...
            Toast.makeText(Test6Activity.this, "Already Recording", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        String fileName = "test6_" + RECORDING_DURATIONS_MIN[recordingDurationIndex] + "_" + samplingRate +  ".csv";
        csvLogger = new CsvLogger(Test6Activity.this, fileName);
        ...
        syncDuringRecording();
        Toast.makeText(Test6Activity.this, "Started Recording", Toast.LENGTH_SHORT).show();
    }
    ...
    private void stopRecording() {
        if (!isRecording) {
            ...
            Toast.makeText(Test6Activity.this, "Not Recording", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (recordingDurationIndex < RECORDING_DURATIONS_MIN.length - 1) {
            ...
            Toast.makeText(Test6Activity.this, "Recording Completed", Toast.LENGTH_SHORT).show();
        }
    }
