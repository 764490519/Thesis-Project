...
public class TestActivity extends ComponentActivity {
    ...
    private final int SAMPLING_RATE = 52;// 13, 26, 52, 104, 208, 416, 833, 1666
//    private final String fileName = "sensor_data_" + SAMPLING_RATE + ".csv";
    private final String fileName = "sensor_data_" + SAMPLING_RATE + "_" + SYNC_INTERVAL/1000 + ".csv";
...
//                startRecording();
    ...
    private void startRecording() {
        if (isRecording) {
            ...
            Toast.makeText(TestActivity.this, "Already Recording", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        syncDuringRecording();
        Toast.makeText(TestActivity.this, "Started Recording", Toast.LENGTH_SHORT).show();
    }
    ...
    private void stopRecording() {
        if (!isRecording) {
            ...
            Toast.makeText(TestActivity.this, "Not Recording", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    public void subscribeImuData() {
        ...
        mdsSubscription = mdsManager.subscribeImu(SAMPLING_RATE, new MdsNotificationListener() {
            @Override
