...
public class Test1Activity extends ComponentActivity {
...
//    private final long RECORDING_DURATION = 1 * 60 * 60 * 1000;//
    ...
    private int samplingRateIndex = 0;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_test);
        syncLogger = new CsvLogger(this, "test1_time_sync.csv");
...
//                startRecording();
    ...
    private void startRecording() {
        if (isRecording) {
            ...
            Toast.makeText(Test1Activity.this, "Already Recording", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        String fileName = "test1_" + samplingRate + ".csv";
        csvLogger = new CsvLogger(Test1Activity.this, fileName);
...
//        syncDuringRecording();
        Toast.makeText(Test1Activity.this, "Started Recording", Toast.LENGTH_SHORT).show();
    }
    ...
    private void stopRecording() {
        if (!isRecording) {
            ...
            Toast.makeText(Test1Activity.this, "Not Recording", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (samplingRateIndex < SAMPLING_RATES.length - 1) {
            ...
            Toast.makeText(Test1Activity.this, "Stopped Recording", Toast.LENGTH_SHORT).show();
        }
    }
