...
public class Test2Activity extends ComponentActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        syncLogger = new CsvLogger(this, "test2_sync_time.csv");
    ...
    private void startRecording() {
        if (isRecording) {
            ...
            Toast.makeText(Test2Activity.this, "Already Recording", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        String fileName = "test2_" + RECORDING_DURATIONS_MIN[recordingDurationIndex] + ".csv";
        csvLogger = new CsvLogger(Test2Activity.this, fileName);
...
//        syncDuringRecording();
        Toast.makeText(Test2Activity.this, "Started Recording", Toast.LENGTH_SHORT).show();
    }
    ...
    private void stopRecording() {
        if (!isRecording) {
            ...
            Toast.makeText(Test2Activity.this, "Not Recording", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (recordingDurationIndex < RECORDING_DURATIONS_MIN.length - 1) {
            ...
            Toast.makeText(Test2Activity.this, "Recording Completed", Toast.LENGTH_SHORT).show();
        }
    }
